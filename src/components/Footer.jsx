            ...
            <div className="max-w-7xl mx-auto px-6 md:px-10 grid md:grid-cols-4 gap-20 mb-32 relative z-10">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-slate-400 font-bold text-[10px] tracking-widest uppercase">
                        ...
                        <li><a href="https://www.amazon.com/stores/AcaMed/page/914B4FB0-A22A-4794-A9D1-465DECA1B26E" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">{t('nav.stories')}</a></li>
                    </ul>
                </div>
