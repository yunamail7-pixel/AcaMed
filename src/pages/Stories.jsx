...
import { History, Award, Microscope } from 'lucide-react';
    ...
    return (
        <div className="bg-lab-gray min-h-screen">
            ...
            <section className="max-w-7xl mx-auto px-6 md:px-10 pb-40">
                    ...
                    <div className="col-span-1 border-r border-slate-100 pr-10">
                        <ScrollReveal>
                            <h2 className="text-3xl font-black mb-8 flex items-center gap-4 text-slate-900">
                                <div className="p-3 bg-secondary text-white rounded-xl shadow-lg shadow-secondary/20"><History size={20} /></div>
                            ...
                            {timeline.map((item, i) => (
                                <ScrollReveal key={i} delay={i * 0.1}>
                                    <div className="relative flex items-start group cursor-default">
                                        <div className="absolute -left-[54px] top-2 w-7 h-7 rounded-full bg-white border border-slate-200 z-10 flex items-center justify-center group-hover:border-secondary transition-colors duration-500 group-hover:scale-110 shadow-sm">
                                            <div className="w-2 h-2 rounded-full bg-slate-300 group-hover:bg-secondary transition-colors" />
                                        </div>
                                        <div className="flex-1 hover:translate-x-2 transition-transform duration-300">
                                            <span className="text-[10px] font-mono font-black text-secondary tracking-[0.3em] mb-4 block group-hover:text-emerald-600 transition-colors">EVOL: {item.year}</span>
                                            ...
                                            <div className="h-px w-0 bg-slate-100 group-hover:w-full transition-all duration-1000 bg-gradient-to-r from-secondary/50 to-transparent" />
                                        </div>
                                    </div>
                                </ScrollReveal>
                            ))}
                ...
                {/* 創辦人故事：更有科研紀錄片質感 */}
                <ScrollReveal>
                    <div className="bg-white border border-slate-100 rounded-[4rem] p-16 lg:p-32 flex flex-col lg:flex-row gap-32 items-center shadow-2xl relative overflow-hidden group hover:shadow-[0_32px_80px_-16px_rgba(0,0,0,0.1)] transition-all duration-700">
                        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-secondary to-transparent group-hover:via-emerald-400 transition-colors duration-700" />
                        <div className="flex-1 space-y-12 relative z-10">
                            ...
                            <p className="text-xl text-slate-500 leading-relaxed font-normal italic border-l-4 border-secondary pl-10 group-hover:border-emerald-400 transition-colors duration-500">
                            ...
                            <div className="flex space-x-12 pt-10">
                                <div className="space-y-2 group/stat">
                                    <div className="flex items-baseline space-x-2">
                                        <span className="stat-value text-slate-900 text-4xl font-black group-hover/stat:text-secondary transition-colors">40</span>
                                ...
                                <div className="space-y-2 group/stat">
                                    <div className="flex items-baseline space-x-2">
                                        <span className="stat-value text-slate-900 text-4xl font-black group-hover/stat:text-secondary transition-colors">50</span>
                                ...
                                <div className="space-y-2 group/stat">
                                    <div className="flex items-baseline space-x-2">
                                        <div className="stat-value text-slate-900 text-4xl font-black group-hover/stat:text-secondary transition-colors">FDA</div>
                                    </div>
                                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Regulatory Standards</p>
                                </div>
                            </div>
                        </div>
                        <div className="flex-1 w-full relative group/image lg:max-w-md">
                            <div className="absolute -inset-4 border border-slate-200 rounded-[3rem] group-hover/image:border-secondary/20 transition-all duration-700 blur-sm opacity-50" />
                            <div className="rounded-[2.5rem] overflow-hidden shadow-2xl relative aspect-[3/4] bg-slate-100 transform group-hover/image:rotate-1 transition-transform duration-700">
                                <img
                                    src="https://images.unsplash.com/photo-1559839734-2b71f1e598c6?auto=format&fit=crop&q=80&w=1000"
                                    alt="Scientific Rigor"
                                    className="w-full h-full object-cover grayscale opacity-80 group-hover/image:grayscale-0 group-hover/image:opacity-100 transition-all duration-[2s]"
                                />
                                <div className="absolute inset-0 bg-slate-900/10 mix-blend-multiply pointer-events-none" />
                                <div className="absolute inset-x-8 bottom-8 p-10 glass-morphism rounded-2xl border-l-4 border-secondary transform translate-y-4 group-hover/image:translate-y-0 transition-transform duration-700">
